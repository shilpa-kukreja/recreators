...
const page = () => {
  ...
  return (
    <RiddaLayout header={4} footer={4} bodyClass="home-four" menus={menus}>
      {/* Hero Area Start */}
      <section
        id="home"
        className="hero-area-three bgc-lighter-green rel z-2 pt-95 rpt-70 pb-130 rpb-100"
      >
      ...
      {/* About Us Area start */}
      <section id="about" className="about-us-area py-100 rel z-1">
        <div className="container container-1290">
      ...
      <section
        id="services"
        className="our-service-area bordered-top pt-100 pb-70 rel z-1"
      >
        <div className="container container-1290">
      ...
      <section
        id="testimonials"
        className="testimonials-three-area text-center py-100 rel z-1"
      >
